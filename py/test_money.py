...
class TestMoney(unittest.TestCase):
    ...
    def testAddition(self):
        ...
        self.assertEqual(fifteenDollars, portofolio.evaluate(self.bank, "USD"))
    ...
    def testAdditionOfDollarsAndEuros(self):
        ...
        actualValue = portofolio.evaluate(self.bank, "USD")
    ...
    def testAdditionOfDollasAndnWons(self):
        ...
        actualValue = portofolio.evaluate(self.bank, "KRW")
        self.assertEqual(expectedValue, actualValue,
                        "%s != %s"%(expectedValue, actualValue))
